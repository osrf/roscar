...
OUT=$(BIN)/$(NAME)
TC=arm-none-eabi-
OPENOCD=openocd -f interface/ftdi/olimex-arm-usb-tiny-h.cfg -f target/stm32f1x.cfg -f ../common/robotis-opencm.cfg 
#COMMON_SRCS=usb enc parity
COMMON_SRCS=startup stubs led pin systime console delay
